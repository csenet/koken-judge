...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var container, command, stream, readOutput, _a, _b;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0: return [4 /*yield*/, docker.container.create({
                        Image: 'ubuntu',
                        name: "JudgeContainer-".concat(new Date().getMilliseconds()),
                        Tty: true,
                        User: '1000',
                        PidsLimit: 100
                    })];
                ...
                case 2:
                    _c.sent();
                    return [4 /*yield*/, container.exec.create({
                            AttachStdout: true,
                            AttachStderr: true,
                            Cmd: ["echo", "Hello"]
                        })];
                case 3:
                    command = _c.sent();
                    return [4 /*yield*/, command.start({ Detach: false })];
                case 4:
                    stream = _c.sent();
                    readOutput = function (stream) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    _b = (_a = console).log;
                    return [4 /*yield*/, readOutput(stream)];
                case 5:
                    _b.apply(_a, [_c.sent()]);
